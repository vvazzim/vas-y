...
import BouttonAjouterP from 'views/admin/patient/components/AddPatientAction';
import ThreeDotsDropdown from 'views/admin/patient/components/dropDownPatient';
